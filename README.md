...
- **Country Financial ecosystem:** This Database was built base on the Nigeria Banking ecosystem and infrastructure, accounting for the information in `TransOperation.PaymentRail` table
